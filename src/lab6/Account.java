...
public class Account {
	...
	public static Predicate<Account> checkBound = (Account account) -> lowerBound.test(account) && upperBound.test(account);
	...
	// TODO: Task3
	// replace the null with a lambda expression
	public static AddMaker maker = (n) -> (Account account) -> {account.balance += n;};
	...
	public static int getMaxAccountID(List<Account> accounts) {
		// TODO: Task4
		// replace the null with a lambda expression
		Account maxOne = accounts.stream().reduce(new Account(0, -100), (Account account1, Account account2) -> account1.balance > account2.balance ? account1 : account2);
